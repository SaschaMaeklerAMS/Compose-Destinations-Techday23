...
import com.example.singlemoduleapp.destinations.ParameterScreenDestination
...
@Destination
@Composable
fun EnterParameterScreen(navigator: DestinationsNavigator) {
    Column(
        ...
        Button(onClick = {
            navigator.navigate(ParameterScreenDestination(parameter = parameter))
        }) {
            Text(text = "Submit")
        }
    }
